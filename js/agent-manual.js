...
export function agentManualSheet() {
  ...
  leave.body.appendChild(infoRow('⏸', 'What freezes', 'Your district (the deadline is pushed out, and streams do not move its goals until you are back), your ARMY Bomb (it will not go dark), your streak (kept alive for free — it does not grow while you are away), and the inactivity clock.'))
  ...
  leave.body.appendChild(infoRow('🎧', 'Streaming while away', 'Totally fine. Streams still count for XP, your Bomb, ReConnect and everything else — just not toward the frozen district. Come back early if you want them to.'))
